...
Future<Token> getToken(String appId, String appSecret) async {
  ...
  String rediUrl = "http://localhost:8585";
  String url =
      "https://api.instagram.com/oauth/authorize/?client_id=$appId&redirect_uri=$rediUrl&response_type=code";
...
Future<Stream<String>> _server() async {
  print("Instagram _server method called");
  ...
  server.listen((HttpRequest request) async {
    ...
    request.response
      ...
      ..write("<html><h3>Login Sucess wait...</h3></html>");
